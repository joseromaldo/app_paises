<nav class="navbar navbar-dark navbar-expand-lg bg-primary">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarPrincipal">
            <a class="navbar-brand" href="/formaD_conJS/views/home/index.php">Aplication Control</a>
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/formaD_conJS/views/home/index.php">Inicio</a>
                </li>
